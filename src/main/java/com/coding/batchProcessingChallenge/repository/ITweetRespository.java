...
public interface ITweetRespository  extends JpaRepository<Tweet, Long>  {
    ...
    List<IRecommendFriendDTO> recommendFriends(@Param("user") User user,@Param("userId") Long userId,@Param("hashtag") String hashtag, @Param("keyword") String keyword);
    ...
    List<IHashtagCountDTO> getHashtagCount(@Param("user") User user,@Param("userId") Long userId);
